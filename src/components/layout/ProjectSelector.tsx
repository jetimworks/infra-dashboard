...
export function ProjectSelector() {
  ...
  return (
    <div className="relative flex items-center">
      ...
      <select
        className="h-8 rounded-md border border-border bg-surface pl-8 pr-6 text-sm text-fg focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 appearance-none cursor-pointer"
